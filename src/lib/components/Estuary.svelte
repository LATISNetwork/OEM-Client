...
<div class="m-4 my-auto  bg-emerald-500 bg-opacity-10 rounded-lg shadow-md p-8 flex flex-col">
...
<div class="m-4 my-auto  bg-emerald-500 bg-opacity-10 rounded-lg shadow-md p-8 mt-8">
	<h1>Uploaded Updates</h1>
	<div class="m-4 grid grid-cols-8 w-full text-center">
		<h1>Name</h1>
		<h1>Description</h1>
		<h1>Device ID</h1>
		<h1>Version</h1>
	...
	<div class="m-4 w-full  max-h-screen overflow-x-hidden overflow-y-auto">
		{#each updateListJson as update}
			...
			>
				<div class="overflow-x-auto flex flex-wrap">{update.name}</div>
				<div class="overflow-x-auto flex flex-wrap">{update.fileDescription}</div>
				<div class="overflow-x-auto flex flex-wrap">{update.deviceID}</div>
				<div class="overflow-x-auto flex flex-wrap">{update.version}</div>
				<div class="overflow-x-auto flex flex-wrap">{update.cid}</div>
